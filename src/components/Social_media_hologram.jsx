...
Command: npx gltfjsx@6.1.4 social_media_hologram.gltf --transform
...
export default function Model(props) {
  const { nodes, materials } = useGLTF(
    "/social_media_hologram-transformed.glb"
  );
  return (
...
useGLTF.preload("/social_media_hologram-transformed.glb");
